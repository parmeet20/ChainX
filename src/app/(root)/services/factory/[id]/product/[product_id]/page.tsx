...
const ProductDetailPage = () => {
  ...
  const [openCartDialog, setOpenCartDialog] = useState<boolean>(false); // New separate state
              ...
              user?.role !== "WAREHOUSE" && (
                <>
                  <Button
                    ...
                    onClick={() => setOpenCartDialog(true)} // Use the new state
                  >
            ...
            {user?.role === "WAREHOUSE" && (
              <>
                ...
                <AddToCartDialog
                  open={openCartDialog}
                  product={product}
                  setOpen={setOpenCartDialog} // Use the new state
                />
              </>
            )}
            {user?.role === "FACTORY" &&
              ...
              <>
                ...
                {factory && product.publicKey && (
                  <InspectProductDialog
                    ...
                    factoty_pda={factory.publicKey.toString()} // Fixed prop name
